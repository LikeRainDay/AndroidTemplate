...
> reference [MVVMTemplate](https://github.com/Drjacky/MVVMTemplate)
...
- Simplest Adapter Ever (based on
  this [workaround](https://proandroiddev.com/the-best-android-recycler-adapter-youve-ever-seen-probably-177e25279a28))
- Github Actions - CI
